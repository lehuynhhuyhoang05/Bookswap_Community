...
INSERT INTO exchanges (exchange_id, request_id, member_a_id, member_b_id, status, cancellation_reason, member_a_confirmed, member_b_confirmed, meeting_location, meeting_time, meeting_notes, created_at, updated_at) VALUES
 ('10000000-0000-4000-8000-000000000001','req00001-0000-0000-0000-000000000001','44444444-4444-4444-4444-444444444444','33333333-3333-3333-3333-333333333333','COMPLETED',NULL,1,1,'Central Library',NOW()+INTERVAL 1 DAY,'Bring both books',NOW()-INTERVAL 10 DAY,NOW()-INTERVAL 9 DAY),
 ('20000000-0000-4000-8000-000000000002','req00002-0000-0000-0000-000000000002','22222222-2222-2222-2222-222222222222','33333333-3333-3333-3333-333333333333','CANCELLED','USER_CANCELLED',0,0,'Cafe District 1',NOW()+INTERVAL 2 DAY,'Too busy to meet',NOW()-INTERVAL 8 DAY,NOW()-INTERVAL 8 DAY),
 ('30000000-0000-4000-8000-000000000003','req00003-0000-0000-0000-000000000003','44444444-4444-4444-4444-444444444444','66666666-6666-6666-6666-666666666666','CANCELLED','NO_SHOW',1,0,'Co-working Space',NOW()-INTERVAL 6 DAY,'Did not appear',NOW()-INTERVAL 7 DAY,NOW()-INTERVAL 7 DAY),
 ('40000000-0000-4000-8000-000000000004','req00004-0000-0000-0000-000000000004','55555555-5555-5555-5555-555555555555','66666666-6666-6666-6666-666666666666','CANCELLED','BOTH_NO_SHOW',0,0,'Metro Station',NOW()-INTERVAL 5 DAY,'None came',NOW()-INTERVAL 6 DAY,NOW()-INTERVAL 5 DAY),
 ('50000000-0000-4000-8000-000000000005','req00005-0000-0000-0000-000000000005','44444444-4444-4444-4444-444444444444','55555555-5555-5555-5555-555555555555','CANCELLED','DISPUTE',1,1,'Bookstore District 3',NOW()-INTERVAL 3 DAY,'Disagreement about book condition',NOW()-INTERVAL 4 DAY,NOW()-INTERVAL 3 DAY),
 ('60000000-0000-4000-8000-000000000006','req00006-0000-0000-0000-000000000006','33333333-3333-3333-3333-333333333333','22222222-2222-2222-2222-222222222222','EXPIRED',NULL,0,1,'Online meet',NOW()-INTERVAL 1 DAY,'MediumUser never confirmed',NOW()-INTERVAL 3 DAY,NOW()-INTERVAL 2 DAY),
 ('70000000-0000-4000-8000-000000000007','req00007-0000-0000-0000-000000000007','44444444-4444-4444-4444-444444444444','22222222-2222-2222-2222-222222222222','PENDING',NULL,0,0,'City Park',NOW()+INTERVAL 2 DAY,'Awaiting acceptance',NOW()-INTERVAL 1 DAY,NOW()-INTERVAL 1 DAY);
...
INSERT INTO exchange_books (exchange_book_id, exchange_id, book_id, from_member_id, to_member_id, exchange_order, created_at) VALUES
 ('81000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000001','aaaaaaa3-aaaa-aaaa-aaaa-aaaaaaaaaaa3','44444444-4444-4444-4444-444444444444','33333333-3333-3333-3333-333333333333',1,NOW()-INTERVAL 10 DAY),
 ('82000000-0000-4000-8000-000000000002','10000000-0000-4000-8000-000000000001','aaaaaaa2-aaaa-aaaa-aaaa-aaaaaaaaaaa2','33333333-3333-3333-3333-333333333333','44444444-4444-4444-4444-444444444444',2,NOW()-INTERVAL 10 DAY),
 ('83000000-0000-4000-8000-000000000003','20000000-0000-4000-8000-000000000002','aaaaaaa1-aaaa-aaaa-aaaa-aaaaaaaaaaa1','22222222-2222-2222-2222-222222222222','33333333-3333-3333-3333-333333333333',1,NOW()-INTERVAL 8 DAY),
 ('84000000-0000-4000-8000-000000000004','20000000-0000-4000-8000-000000000002','aaaaaaa2-aaaa-aaaa-aaaa-aaaaaaaaaaa2','33333333-3333-3333-3333-333333333333','22222222-2222-2222-2222-222222222222',2,NOW()-INTERVAL 8 DAY),
 ('85000000-0000-4000-8000-000000000005','30000000-0000-4000-8000-000000000003','aaaaaaa3-aaaa-aaaa-aaaa-aaaaaaaaaaa3','44444444-4444-4444-4444-444444444444','66666666-6666-6666-6666-666666666666',1,NOW()-INTERVAL 7 DAY),
 ('86000000-0000-4000-8000-000000000006','30000000-0000-4000-8000-000000000003','aaaaaaa5-aaaa-aaaa-aaaa-aaaaaaaaaaa5','66666666-6666-6666-6666-666666666666','44444444-4444-4444-4444-444444444444',2,NOW()-INTERVAL 7 DAY),
 ('87000000-0000-4000-8000-000000000007','40000000-0000-4000-8000-000000000004','aaaaaaa4-aaaa-aaaa-aaaa-aaaaaaaaaaa4','55555555-5555-5555-5555-555555555555','66666666-6666-6666-6666-666666666666',1,NOW()-INTERVAL 6 DAY),
 ('88000000-0000-4000-8000-000000000008','40000000-0000-4000-8000-000000000004','aaaaaaa5-aaaa-aaaa-aaaa-aaaaaaaaaaa5','66666666-6666-6666-6666-666666666666','55555555-5555-5555-5555-555555555555',2,NOW()-INTERVAL 6 DAY),
 ('89000000-0000-4000-8000-000000000009','50000000-0000-4000-8000-000000000005','aaaaaaa6-aaaa-aaaa-aaaa-aaaaaaaaaaa6','44444444-4444-4444-4444-444444444444','55555555-5555-5555-5555-555555555555',1,NOW()-INTERVAL 4 DAY),
 ('8a000000-0000-4000-8000-000000000010','50000000-0000-4000-8000-000000000005','aaaaaaa4-aaaa-aaaa-aaaa-aaaaaaaaaaa4','55555555-5555-5555-5555-555555555555','44444444-4444-4444-4444-444444444444',2,NOW()-INTERVAL 4 DAY),
 ('8b000000-0000-4000-8000-000000000011','60000000-0000-4000-8000-000000000006','aaaaaaa2-aaaa-aaaa-aaaa-aaaaaaaaaaa2','33333333-3333-3333-3333-333333333333','22222222-2222-2222-2222-222222222222',1,NOW()-INTERVAL 3 DAY),
 ('8c000000-0000-4000-8000-000000000012','60000000-0000-4000-8000-000000000006','aaaaaaa7-aaaa-aaaa-aaaa-aaaaaaaaaaa7','22222222-2222-2222-2222-222222222222','33333333-3333-3333-3333-333333333333',2,NOW()-INTERVAL 3 DAY),
 ('8d000000-0000-4000-8000-000000000013','70000000-0000-4000-8000-000000000007','aaaaaaa6-aaaa-aaaa-aaaa-aaaaaaaaaaa6','44444444-4444-4444-4444-444444444444','22222222-2222-2222-2222-222222222222',1,NOW()-INTERVAL 1 DAY),
 ('8e000000-0000-4000-8000-000000000014','70000000-0000-4000-8000-000000000007','aaaaaaa1-aaaa-aaaa-aaaa-aaaaaaaaaaa1','22222222-2222-2222-2222-222222222222','44444444-4444-4444-4444-444444444444',2,NOW()-INTERVAL 1 DAY);
...
INSERT INTO reviews (review_id, exchange_id, reviewer_id, reviewee_id, rating, comment, created_at, updated_at) VALUES
 ('91000000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000001','44444444-4444-4444-4444-444444444444','33333333-3333-3333-3333-333333333333',5,'Great exchange, smooth process!',NOW()-INTERVAL 9 DAY,NOW()-INTERVAL 9 DAY),
 ('92000000-0000-4000-8000-000000000002','10000000-0000-4000-8000-000000000001','33333333-3333-3333-3333-333333333333','44444444-4444-4444-4444-444444444444',4,'Book as described.',NOW()-INTERVAL 9 DAY,NOW()-INTERVAL 9 DAY),
 ('93000000-0000-4000-8000-000000000003','50000000-0000-4000-8000-000000000005','55555555-5555-5555-5555-555555555555','44444444-4444-4444-4444-444444444444',2,'Dispute about quality.',NOW()-INTERVAL 3 DAY,NOW()-INTERVAL 3 DAY),
 ('94000000-0000-4000-8000-000000000004','50000000-0000-4000-8000-000000000005','44444444-4444-4444-4444-444444444444','55555555-5555-5555-5555-555555555555',1,'Condition not as stated.',NOW()-INTERVAL 3 DAY,NOW()-INTERVAL 3 DAY);
...
INSERT INTO conversations (conversation_id, exchange_request_id, member_a_id, member_b_id, total_messages, last_message_at, created_at) VALUES
 ('a1000000-0000-4000-8000-000000000001','req00007-0000-0000-0000-000000000007','44444444-4444-4444-4444-444444444444','22222222-2222-2222-2222-222222222222',2,NOW()-INTERVAL 1 DAY,NOW()-INTERVAL 1 DAY),
 ('a2000000-0000-4000-8000-000000000002',NULL,'44444444-4444-4444-4444-444444444444','66666666-6666-6666-6666-666666666666',2,NOW()-INTERVAL 7 DAY,NOW()-INTERVAL 7 DAY);

-- Messages (sender_id / receiver_id)
INSERT INTO messages (message_id, conversation_id, sender_id, receiver_id, content, is_read, sent_at, created_at) VALUES
 ('b1000000-0000-4000-8000-000000000001','a1000000-0000-4000-8000-000000000001','44444444-4444-4444-4444-444444444444','22222222-2222-2222-2222-222222222222','Hi, interested in your Clean Code book!',0,NOW()-INTERVAL 1 DAY,NOW()-INTERVAL 1 DAY),
 ('b2000000-0000-4000-8000-000000000002','a1000000-0000-4000-8000-000000000001','22222222-2222-2222-2222-222222222222','44444444-4444-4444-4444-444444444444','Sure, would you trade Design Patterns?',0,NOW()-INTERVAL 1 DAY,NOW()-INTERVAL 1 DAY),
 ('b3000000-0000-4000-8000-000000000003','a2000000-0000-4000-8000-000000000002','44444444-4444-4444-4444-444444444444','66666666-6666-6666-6666-666666666666','You missed the meeting yesterday.',0,NOW()-INTERVAL 7 DAY,NOW()-INTERVAL 7 DAY),
 ('b4000000-0000-4000-8000-000000000004','a2000000-0000-4000-8000-000000000002','66666666-6666-6666-6666-666666666666','44444444-4444-4444-4444-444444444444','Sorry, something came up.',0,NOW()-INTERVAL 7 DAY,NOW()-INTERVAL 7 DAY);
...
INSERT INTO user_activity_logs (log_id, user_id, action, entity_type, entity_id, metadata, ip_address, user_agent, created_at) VALUES
 ('c1000000-0000-4000-8000-000000000001','00000000-0000-0000-0000-000000000004','CREATE_EXCHANGE_REQUEST','EXCHANGE_REQUEST','req00007-0000-0000-0000-000000000007',JSON_OBJECT('info','Created request'),NULL,NULL,NOW()-INTERVAL 2 DAY),
 ('c2000000-0000-4000-8000-000000000002','00000000-0000-0000-0000-000000000002','ACCEPT_EXCHANGE_REQUEST','EXCHANGE_REQUEST','req00002-0000-0000-0000-000000000002',JSON_OBJECT('info','Accepted request'),NULL,NULL,NOW()-INTERVAL 8 DAY),
 ('c3000000-0000-4000-8000-000000000003','00000000-0000-0000-0000-000000000006','SEND_MESSAGE','MESSAGE','b3000000-0000-4000-8000-000000000003',JSON_OBJECT('content','You missed the meeting'),NULL,NULL,NOW()-INTERVAL 7 DAY),
 ('c4000000-0000-4000-8000-000000000004','00000000-0000-0000-0000-000000000004','CREATE_REVIEW','REVIEW','91000000-0000-4000-8000-000000000001',JSON_OBJECT('rating',5),NULL,NULL,NOW()-INTERVAL 9 DAY);
