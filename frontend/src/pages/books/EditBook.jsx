  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        setErrors({ submit: 'Bạn chỉ có thể chỉnh sửa sách của chính mình' });
      } else if (response.status === 404) {
        setErrors({ submit: 'Không tìm thấy sách' });
      } else {
        const errorData = await response.json();
        setErrors({ submit: errorData.message || 'Có lỗi xảy ra khi cập nhật sách' });
      }
    } catch (error) {
          ...
          <div className="bg-gradient-to-r from-amber-500 to-orange-500 px-8 py-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-amber-100">Cập nhật thông tin sách của bạn</p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <div className="flex items-center space-x-2">
                    <span className="font-semibold text-gray-900">{book.owner.name}</span>
                    {book.owner.verified && (
              ...
              <div className="flex items-center space-x-6 text-sm">
                <div className="text-center">
                  ...
                  <div className="font-semibold text-gray-900">{book.rating}</div>
                ...
                <div className="text-center">
                  ...
                  <div className="font-semibold text-gray-900">{book.exchanges}</div>
                ...
                <div className="text-center">
                  ...
                  <div className="font-semibold text-gray-900">{book.views}</div>
